...
A highly polished, feature-rich **Android application** crafted with **Kotlin** and **Jetpack Compose**. NutriAI combines traditional macro-tracking with state-of-the-art Generative AI to provide a frictionless meal tracking, nutrition advice, and weight monitoring experience.
...
NutriAI follows a custom **Unified Cosmic Palette** based on modern **Material Design 3 (M3)** principles:
...
3.  **Choose Repo Options**: Specify whether you want to create a new private or public repository and give it a title (e.g., `NutriAI-Nutrition-Tracker`).
